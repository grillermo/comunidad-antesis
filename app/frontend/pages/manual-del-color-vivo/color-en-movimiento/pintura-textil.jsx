...
export default function Page({ title }) {
  return (
    <ManualLayout title={title}>
      ...
      <Recipe rendimiento={""} tiempo={"30 minutos de trabajo activo. Después se necesita una a dos semanas de curado antes del primer enjuague."}>
        <Steps>
          <li>Prepara leche de soya fresca (puedes encontrar <Link href="/manual-del-color-vivo/color-sobre-fibra/modificadores-y-tratamientos-de-color/leche-de-soya/receta-de-leche-de-soya-casera" className="underline text-orange-ink hover:text-orange">la receta</Link> en el capítulo de Modificadores y tratamientos de color).</li>
