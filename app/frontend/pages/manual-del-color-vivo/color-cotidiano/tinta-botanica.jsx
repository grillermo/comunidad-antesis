...
export default function Page({ title }) {
  return (
    <ManualLayout title={title}>
      <p>A lo largo de la historia, diversas culturas han aprovechado plantas, raíces, cortezas y frutos para obtener colores; estas tintas son básicamente los mismos tintes que usamos para teñir, pero más concentrados y con un aglutinante que facilita su aplicación sobre papel. Producen tonos naturales y orgánicos, aunque no son muy resistentes a la luz;</p>
      <p>son ideales para ilustración experimental, papel decorativo, papel artesanal, proyectos escolares o como material de arte para niños.</p>
      <p>Este es uno de mis materiales de arte favoritos. Puedes preparar una tinta de varias formas: reduciendo un tinte sobrante de teñido con más calor, dejando que se evapore para que el color se concentre, o haciendo una extracción nueva desde cero. Además, puedes aplicar todo lo que aprendiste en la sección de teñido sobre modificadores de color y pH para crear distintos efectos e interacciones con tus tintas.</p>
