  ...
  return (
    <ManualLayout title={title}>
      <ul className="list-disc space-y-3 pl-6 marker:text-orange">
        ...
        <li>Consulta el Atlas del color al final del manual. Ahí encontrarás una selección de plantas tintóreas, que parte de cada una usar y qué color obtendrás.</li>
