  ...
  return (
    <ManualLayout title={title}>
      ...
      <pre className="overflow-x-auto whitespace-pre font-body text-sm leading-6">Materiales
         •   Tela 100% algodón o lino         •   5 gramos de carbonato de
             (pesa aproximadamente 100            calcio
             gramos)
                                              •   100 gramos de rubia
         •   Jabón
                                              •   Olla
         •   10 gramos de ácido tánico
                                              •   Agua
         •   10 gramos de alumbre potásico o acetato de aluminio       •   Fuente de calor</pre>
