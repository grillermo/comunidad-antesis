...
export default function Page({ title }) {
  return (
    <ManualLayout title={title}>
      ...
      <p>Hay dos procedimientos que yo sigo, dependiendo del textil: <Link href="/manual-del-color-vivo/color-sobre-fibra/guia-de-lavado/lavado-simple" className="underline text-orange-ink hover:text-orange">lavado simple</Link> y <Link href="/manual-del-color-vivo/color-sobre-fibra/guia-de-lavado/descrudado" className="underline text-orange-ink hover:text-orange">descrudado</Link>. Si el textil es nuevo o crudo —es decir, nunca ha sido lavado ni tratado después del hilado o tejido— necesitas descrudarlo. Para todo lo demás, basta con un lavado simple.</p>
      ...
      <ul className="list-disc space-y-3 pl-6 marker:text-orange">
        ...
        <li>El carbonato de sodio, también llamado sosa de lavar o soda ash, no es lo mismo que el bicarbonato de sodio. Es más alcalino y sirve para abrir la fibra vegetal y desprender impurezas. Ver sección <Link href="/manual-del-color-vivo/el-origen-del-color/preparacion-de-carbonatos" className="underline text-orange-ink hover:text-orange">Preparación de carbonatos</Link>.</li>
