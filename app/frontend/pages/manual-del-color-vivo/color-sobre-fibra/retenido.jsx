...
export default function Page({ title }) {
  return (
    <ManualLayout title={title}>
      ...
      <ul className="list-disc space-y-3 pl-6 marker:text-orange">
        <li>Cempasúchil + índigo = verde militar</li>
        <li>Gualda + índigo = verde espárrago</li>
        <li>Índigo + cáscara de granada = verde menta</li>
        <li>Cáscara de granada + grana cochinilla = durazno</li>
        <li>Grana cochinilla + cáscara de cebolla = ladrillo</li>
        <li>Índigo + grana cochinilla = órcela</li>
        <li>Rubia + grana cochinilla = carmín</li>
        <li>Grana cochinilla + palo de Campeche = berenjena</li>
      </ul>
