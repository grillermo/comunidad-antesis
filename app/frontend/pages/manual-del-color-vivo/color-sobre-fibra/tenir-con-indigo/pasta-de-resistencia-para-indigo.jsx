...
export default function Page({ title }) {
  return (
    <ManualLayout title={title}>
      <p>Una de las formas más comunes de realizar estampados y motivos con tinta de índigo es a base de doblar, torcer, atar, comprimir o coser el textil para bloquear el tinte y crear patrones geométricos o abstractos. Si te interesa profundizar en el tema, te recomiendo investigar técnicas de tie-dye, shibori e ikat.</p>
