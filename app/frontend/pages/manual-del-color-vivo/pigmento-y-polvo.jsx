  ...
  return (
    <ManualLayout title={title} hideTitle>
      <PartDivider image={divider} title={title}>
          ...
          <p>En esta sección te enseñaré a preparar todos estos polvos para que en el <Link href="/manual-del-color-vivo/color-en-movimiento" className="underline text-orange-ink hover:text-orange">siguiente capítulo</Link> los conviertas en pintura, tinta y otros materiales de arte.</p>
      </PartDivider>
    </ManualLayout>
  )
}
